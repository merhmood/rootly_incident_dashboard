...
Once the API key is set, the dashboard will automatically switch from mock data to live data from your Rootly instance. You can verify this in the **Incident Log** section at the bottom of the page.
